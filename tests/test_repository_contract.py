...
class RepositoryContractTest(unittest.TestCase):
    ...
    def test_score_rubric_classifies_generalized_ux_and_business_states(self):
        ...
        expected = {
            ...
            "ընդհանուր բացակայության դասը": (
                ...
                "բացակայությունը ձևակերպված է միայն ընդհանրական վիճակով կամ ընդհանուր կարգային գոյականով՝ առանց տիրույթային հղման",
                ["–", "`7.0`", "–", "`6.0`", "`4.0`"],
            ),
    ...
    def test_hy_inf_006_preserves_link_text_coverage_and_adds_concrete_microcopy_scope(self):
        ...
        for fragment in (
            ...
            "Ընդհանուր կարգային գոյականը առանց տիրույթային հղման",
            "UX և գործարար միկրոտեքստ",
            "անմիջական համատեքստում",
            "տեսանելի կամ մատչելի համատեքստը",
            "Ընդհանուր կարգային գոյականը թույլատրելի է, երբ տեսանելի կամ մատչելի համատեքստը",
